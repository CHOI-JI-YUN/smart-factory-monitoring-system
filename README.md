...
Python Flask, MFC, WinForms, YOLO 기반의 생산라인 모니터링 및 실시간 채팅 시스템
...
Python Flask 서버를 중심으로 현장 관리자(MFC), 현장 카메라(WinForms), 전체 관리자(Web) 간 데이터를 실시간으로 처리하도록 구성했습니다.
...
- Python Flask 중심의 서버-클라이언트 구조 설계
